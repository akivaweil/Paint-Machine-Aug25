...
#define SERVO_PAINTING_ANGLE 230.0     // Servo angle during painting operations
...
#define STEP8_BACK_LEFT_WAIT_MS 100                    // Wait time on back left before servo movement (milliseconds)
#define STEP8_SERVO_BACK_ANGLE_DEG 150.0               // Servo angle for back left/right positions (degrees)
#define STEP8_BACK_LEFT_SERVO_SPEED 100.0               // Servo movement speed for back left (degrees per second)
#define STEP8_BACK_LEFT_PAINT_DELAY_MS 5            // Delay at back angle position for painting (milliseconds)
...
#define STEP10_BACK_SIDE_WAIT_MS 100                    // Wait time on back side before servo movement (milliseconds)
#define STEP10_SERVO_BACK_ANGLE_DEG 160.0              // Servo angle for back position (degrees)
#define STEP10_BACK_SERVO_SPEED 100.0                   // Servo movement speed for back (degrees per second)
#define STEP10_BACK_PAINT_DELAY_MS 5                // Delay at back angle position for painting (milliseconds)
...
#define STEP12_BACK_RIGHT_WAIT_MS 200                  // Wait time on back right before servo movement (milliseconds)
#define STEP12_SERVO_BACK_ANGLE_DEG 160.0             // Servo angle for back right position (degrees)
#define STEP12_BACK_RIGHT_SERVO_SPEED 50.0             // Servo movement speed for back right (degrees per second)
#define STEP12_BACK_RIGHT_PAINT_DELAY_MS 50           // Delay at back angle position for painting (milliseconds)
...
#define STEP14_RIGHT_SIDE_WAIT_MS 200                    // Wait time on right side before servo movement (milliseconds)
#define STEP14_SERVO_RIGHT_ANGLE_DEG 180.0             // Servo angle for right side position (degrees)
#define STEP14_RIGHT_SERVO_SPEED 60.0                  // Servo movement speed for right side (degrees per second)
#define STEP14_RIGHT_PAINT_DELAY_MS 200                 // Delay at right angle position for painting (milliseconds)
...
//╚═══╝ ════════════════════════════════════════════════════════════════ ╚═══╝
#define STEP15_FINAL_ROTATION_REV 1.25                 // Final rotation amount (450 degrees = 1.25 revolutions)
...
#define STEP17_INITIAL_ANGLE_WAIT_MS 100               // Wait time at initial angle before moving to home (milliseconds)
#define STEP17_SERVO_SPEED 120.0                       // Servo movement speed for final face coat (degrees per second)
