...
#define STEP8_BACK_LEFT_WAIT_MS 200                    // Wait time on back left before servo movement (milliseconds)
#define STEP8_SERVO_BACK_ANGLE_DEG 160.0               // Servo angle for back left/right positions (degrees)
#define STEP8_BACK_LEFT_SERVO_SPEED 80.0               // Servo movement speed for back left (degrees per second)
#define STEP8_BACK_LEFT_PAINT_DELAY_MS 200             // Delay at back angle position for painting (milliseconds)
...
#define STEP10_BACK_SIDE_WAIT_MS 200                    // Wait time on back side before servo movement (milliseconds)
#define STEP10_SERVO_BACK_ANGLE_DEG 160.0              // Servo angle for back position (degrees)
#define STEP10_BACK_SERVO_SPEED 80.0                   // Servo movement speed for back (degrees per second)
#define STEP10_BACK_PAINT_DELAY_MS 200                 // Delay at back angle position for painting (milliseconds)
...
#define STEP12_BACK_RIGHT_SERVO_SPEED 80.0             // Servo movement speed for back right (degrees per second)
#define STEP12_BACK_RIGHT_PAINT_DELAY_MS 200           // Delay at back angle position for painting (milliseconds)
...
#define STEP14_RIGHT_SERVO_SPEED 80.0                  // Servo movement speed for right side (degrees per second)
