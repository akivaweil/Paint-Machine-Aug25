...
#define HOME_SWITCH_DEBOUNCE_MS 20         // Debounce time for home switches to prevent false triggers (reduced for faster response)
...
#define X_HOME_DISTANCE_STEPS 10000       // Steps to move during X homing
...
#define X_MOVE_AWAY_DIRECTION_POSITIVE true    // X moves positive to get away from home switch
